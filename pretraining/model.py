...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type, override_args=None):
        ...
        if model_type == 'gpt2':
            ...
            config.block_size = 1024   # GPT-2 context window
            config.n_layer = 12
            config.n_head = 12
            config.n_embd = 768
            config.dropout = 0.1
        ...
        # Override any defaults with provided arguments
    ...
    def configure_optimizers(self, weight_decay, learning_rate, betas, device_type):
        ...
        # create groups with one group per parameter
